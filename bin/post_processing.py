...
class Pharok:
    ...
    def process_results(self):
        ...
        merged_df["category"] = merged_df["category"].str.replace(
            "No_PHROG_for_ENVHOG", "unknown function"
        )
    ...
    def create_gff(self):
        ...
        self.merged_df["attributes"] = (
            ...
            + ";"
            + "envhog="
            + self.merged_df["envhog"].astype(str)
            + ";"
            + "locus_tag="
            + locus_df["locus_tag"].astype(str)
            + ";"
...
def process_pyhmmer_results(merged_df, pyhmmer_results_dict):
    ...
    merged_df["envhog"] = "No_ENVHOG"
    merged_df["pyhmmer_bitscore"] = "No_ENVHOG"
    merged_df["pyhmmer_evalue"] = "No_ENVHOG"
